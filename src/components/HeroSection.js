  ...
  return (
    <div className='flex flex-col sm:flex-row items-center justify-center gap-40 p-10 min-h-screen bg-gradient-to-tr from-blue-50 to-indigo-50'>
      ...
      <div className='max-w-xl text-center sm:text-left'>
        ...
        <a className='px-6' href='https://www.linkedin.com/in/mohan-ashapu-724aba258/'><i class="fa-brands fa-linkedin fa-lg transition-transform duration-300 hover:scale-130"></i></a>
        <a href='mailto:ashapumohan123@gmail.com'><i class="fa-solid fa-envelope fa-lg transition-transform duration-300 hover:scale-130"></i></a>
        <a href='https://wa.me/917989909756?text=Hi%2C%20Ashapu%20Mohan,%20I%27m%20interested%20in%20your%20services.'><i class="fa-brands fa-whatsapp fa-lg transition-transform duration-300 hover:scale-130 p-5"></i></a>
      </div>
    </div>
  );
}
