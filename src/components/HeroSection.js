  ...
  return (
    <div className='flex flex-col sm:flex-row items-center justify-center gap-40 p-10 min-h-screen bg-slate-50'>
      ...
      <div className='max-w-xl text-center sm:text-left'>
        ...
        <a href='https://wa.me/917989909756?text=Hi%2C%20I%27m%20interested%20in%20your%20services.'><i class="fa-brands fa-whatsapp transition-transform duration-300 hover:scale-180 p-5"></i></a>
      </div>
    </div>
  );
}
